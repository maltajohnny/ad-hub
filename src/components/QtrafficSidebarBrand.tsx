...
/**
 * Marca Qtraffic na sidebar autenticada (não usar na landing).
 * QTRAFFIC ligeiramente maior que no header da landing; tagline mais compacta.
 */
export function QtrafficSidebarBrand() {
  return (
    <div className="flex min-w-0 w-full items-center gap-2.5 text-left">
      ...
      <div className="flex min-w-0 flex-col justify-center gap-0.5 border-l border-sidebar-border/45 pl-2.5">
        <span className="font-display text-[15px] font-bold leading-none tracking-[0.11em] text-sidebar-foreground sm:text-[16px]">
          QTRAFFIC
        </span>
