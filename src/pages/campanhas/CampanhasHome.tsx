...
import { MapPin, Sparkles, Scale, FileEdit } from "lucide-react";
...
export default function CampanhasHome() {
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap gap-2">
        ...
        <Button type="button" size="sm" variant="outline" className="gap-1.5" asChild>
          <Link to="/campanhas/segmentacao-geografica">
            <MapPin className="h-3.5 w-3.5" />
            Segmentação geográfica
          </Link>
        </Button>
        <Button type="button" size="sm" variant="outline" className="gap-1.5" asChild>
          <Link to="/campanhas/estrategia">
            <Scale className="h-3.5 w-3.5" />
            Formulário vs landing
          </Link>
        </Button>
        <Button type="button" size="sm" variant="outline" className="gap-1.5" asChild>
          <Link to="/campanhas/leads">
